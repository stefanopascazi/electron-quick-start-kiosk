...
var fs_1 = require("fs");
var audioBufferToWav = require('./components/convert');
...
var getFile = function (file) {
    if (file === void 0) { file = "/home/stefano/Scaricati/Swing_Jazz_Drum.mp3"; }
...
electron_1.ipcMain.handle("get_audio", function (e, args) { return __awaiter(void 0, void 0, void 0, function () {
    var aBuffer, oUrl;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getFile(args)];
            case 1:
                aBuffer = _a.sent();
                oUrl = audioBufferToWav(aBuffer);
                return [2 /*return*/, oUrl];
        }
    });
}); });
